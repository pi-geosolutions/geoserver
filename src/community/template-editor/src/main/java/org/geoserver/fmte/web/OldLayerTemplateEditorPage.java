...
public class OldLayerTemplateEditorPage extends GeoServerSecuredPage {
    private static final Logger LOGGER = Logging.getLogger(OldLayerTemplateEditorPage.class);
    ...
    public OldLayerTemplateEditorPage() {
    }

    public OldLayerTemplateEditorPage(PageParameters parameters) {
